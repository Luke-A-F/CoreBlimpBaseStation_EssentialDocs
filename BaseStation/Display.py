...
class Display:
    ...
    def drawConnections(self):
        ...
        self.screen.blit(self.textSurface_Input,(self.anchor_x_input,self.anchor_y_input))
        self.screen.blit(self.textSurface_Blimps,(self.anchor_x_blimps,self.anchor_y_blimps))
        self.screen.blit(self.textSurface_State,(self.anchor_x_blimpState,self.anchor_y_blimpState))
        self.screen.blit(self.textSurface_Status,(self.anchor_x_blimpStatus,self.anchor_y_blimpStatus))
        ...
        for i in range(0,len(inputs)):
            ...
            input = self.blimpHandler.inputs[i].getInput()
        ...
        for i in range(0,len(blimps)):
            blimpSurface = blimps[i].getNameSurface().convert_alpha()
